...
public class ManageAssetsActivity extends BaseAppCompatActivity {
        ...
        dialog.setOnShowListener(dialogInterface -> {
            ...
            positiveButton.setOnClickListener(view -> {
                ...
                if (checkedChipId == R.id.chip_file) {
                    ...
                    SketchwareUtil.toast(Helper.getResString(R.string.select_a_file_type));
                    return;
                }
        ...
        dialog.setDialogSelectionListener(selections -> {
            for (String path : selections) {
                ...
                try {
                    ...
                    SketchwareUtil.toastError(Helper.getResString(R.string.couldn_t_import_file) + e.getMessage() + "]");
                }
            }
        });
    ...
    private void showDeleteDialog(final int position) {
        new MaterialAlertDialogBuilder(this)
                ...
                .setMessage(R.string.are_you_sure_you_want_to_delete_this + (assetsAdapter.isFolder(position) ? getString(R.string.common_word_folder): getString(R.string.common_word_file)) + "? "
