...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupViews() {
        ...
        createToolsView(R.drawable.event_on_item_clicked_48dp, getString(R.string.event_manager), getString(R.string.manage_your_own_events), content, openSettingsActivity(), false);
        ...
        createToolsView(R.drawable.ic_folder_48dp, getString(R.string.open_working_directory), getString(R.string.open_sketchware_pro_s_directory_and_edit_files_in_it), content, v -> openWorkingDirectory(), false);
    ...
    private View.OnClickListener openSettingsActivity() {
        return v -> {
            Intent intent = new Intent(v.getContext(), SettingsActivity.class);
            intent.putExtra("fragment_tag", SettingsActivity.EVENTS_MANAGER_FRAGMENT);
    ...
    private void signApkFileDialog() {
        ...
        apkPathDialog.b(getString(R.string.sign_an_apk_file_with_testkey));
