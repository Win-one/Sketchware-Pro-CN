...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        managersCategory.setTitle(getString(R.string.common_word_managers));
        preferences.add(managersCategory);

        managersCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_block, getString(R.string.block_manager), getString(R.string.manage_your_own_blocks_to_use_in_logic_editor), new ActivityLauncher(new Intent(getApplicationContext(), BlocksManager.class))), true);
        managersCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_pull_down, getString(R.string.block_selector_menu_manager), getString(R.string.manage_your_own_block_selector_menus), openSettingsActivity(SettingsActivity.BLOCK_SELECTOR_MANAGER_FRAGMENT)), true);
        managersCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_component, getString(R.string.component_manager), getString(R.string.manage_your_own_components), new ActivityLauncher(new Intent(getApplicationContext(), ManageCustomComponentActivity.class))), true);
        managersCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_list, getString(R.string.event_manager), getString(R.string.manage_your_own_events), openSettingsActivity(SettingsActivity.EVENTS_MANAGER_FRAGMENT)), true);
        managersCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_box, getString(R.string.local_library_manager), getString(R.string.manage_and_download_local_libraries), new ActivityLauncher(new Intent(getApplicationContext(), ManageLocalLibraryActivity.class), new Pair<>("sc_id", "system"))), true);
        ...
        generalCategory.setTitle(getString(R.string.common_word_general));
        preferences.add(generalCategory);

        generalCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_settings_applications, getString(R.string.mod_settings), getString(R.string.change_general_mod_settings), new ActivityLauncher(new Intent(getApplicationContext(), ConfigActivity.class))), true);
        generalCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_folder, getString(R.string.open_working_directory), getString(R.string.open_sketchware_pro_s_directory_and_edit_files_in_it), v -> openWorkingDirectory()), true);
        generalCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_apk_document, getString(R.string.sign_an_apk_file_with_testkey), getString(R.string.sign_an_already_existing_apk_file), v -> signApkFileDialog()), true);
    ...
    private void openWorkingDirectory() {
        ...
        options.setTitle(getString(R.string.select_an_entry_to_modify));
    ...
    private void signApkFileDialog() {
        ...
        apkPathDialog.setPositiveButton(R.string.common_word_continue, (v, which) -> {
            ...
            if (new File(output_apk_path).exists()) {
                ...
                confirmOverwrite.setTitle(R.string.file_exists);
                confirmOverwrite.setMessage(R.string.an_apk_named+ output_apk_file_name + " already exists at /sketchware/signed_apk/.  Overwrite it?");

                confirmOverwrite.setNegativeButton(R.string.common_word_cancel, null);
