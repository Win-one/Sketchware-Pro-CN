...
public class BlocksManager extends BaseAppCompatActivity {
    ...
    private void showBlockConfigurationDialog() {
        ...
        dialog.setTitle(R.string.block_configuration);
        ...
        dialog.setNeutralButton(getString(R.string.common_word_default), (view, which) -> {
    ...
    private void recycleBin(View view) {
        ...
        view.setOnLongClickListener(v -> {
            new MaterialAlertDialogBuilder(this)
                    ...
                    .setMessage(R.string.are_you_sure_you_want_to_empty_the_recycle_bin +
                            R.string.blocks_inside_will_be_deleted_permanently_you_cannot_recover_them)
    ...
    private void showPaletteDialog(boolean isEditing, Integer oldPosition, String oldName, String oldColor, Integer insertAtPosition) {
        MaterialAlertDialogBuilder dialog = new MaterialAlertDialogBuilder(this);
        dialog.setIcon(R.drawable.ic_mtrl_palette);
        dialog.setTitle(!isEditing ? getString(R.string.create_a_new_palette) : getString(R.string.edit_palette));
